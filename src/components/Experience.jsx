    ...
    <section id="experience" className="scroll-mt-24 border-y border-white/5 bg-surface py-28">
      <div className="container-x">
        ...
        <div className="relative mt-14 pl-8 sm:pl-0">
          {/* vertical line */}
          <div className="absolute left-2 top-0 h-full w-px bg-gradient-to-b from-accent via-accent2 to-transparent sm:left-1/2" />
            ...
            {timeline.map((item, i) => {
              ...
              return (
                <li key={item.year} className="relative sm:grid sm:grid-cols-2 sm:gap-10">
                  {/* node */}
                  <span className="absolute left-[-1.55rem] top-1.5 h-3.5 w-3.5 rounded-full border-2 border-accent2 bg-ink sm:left-1/2 sm:-translate-x-1/2" />
